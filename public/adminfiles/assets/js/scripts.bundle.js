...
KTUtil.ready(function() {
    ...
    // Init Quick User Setting Panel
    if (typeof KTLayoutQuickUserSetting !== 'undefined') {
        KTLayoutQuickUserSetting.init('kt_quick_user_setting');
    }
...
var KTLayoutQuickUserSetting = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_user_setting_close',
            toggleBy:'kt_quick_user_setting_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTLayoutQuickUserSetting;
}

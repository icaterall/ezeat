...
<a target="_blank" href= "/admin_gate/switch-user/{{$row->users->first()->id}}" class="remove-record btn btn-icon btn-light btn-hover-primary btn-sm">
...
@endcan
	...
	<a href="{{route('admin.restaurants.edit',$row->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
...
<a data-toggle="modal" data-url= "{{ route('admin.restaurants.destroy',$row->id)}}" data-id="{{$row->id}}" data-target="#delete-modal" class="remove-record btn btn-icon btn-light btn-hover-primary btn-sm">
  <span class="svg-icon svg-icon-md svg-icon-primary">
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			<rect x="0" y="0" width="24" height="24"></rect>

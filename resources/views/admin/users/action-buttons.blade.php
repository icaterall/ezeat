...
@can('admin_privilege')
<a target="_blank" href= "/admin_gate/switch-user/{{$row->id}}" class="remove-record btn btn-icon btn-light btn-hover-primary btn-sm">
 <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo12\dist/../src/media/svg/icons\Home\Door-open.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
...
@endcan
	...
	<a href="{{route('admin.users.edit',$row->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
...
<a data-toggle="modal" data-url= "{{ route('admin.users.destroy',$row->id)}}" data-id="{{$row->id}}" data-target="#delete-modal" class="remove-record btn btn-icon btn-light btn-hover-primary btn-sm">
  <span class="svg-icon svg-icon-md svg-icon-primary">
	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			<rect x="0" y="0" width="24" height="24"></rect>

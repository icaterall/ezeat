                                ...
                                <div class="row">
                                                ...
                                                <div class="card-spacer bg-white card-rounded flex-grow-1">
                                                    ...
                                                    <div class="row m-0">
                                                        <div class="col px-8 py-6 mr-8">
                                                            ...
                                                            <div class="font-size-h4 font-weight-bolder">MYR {{$payment_summary['admin_payment']}}</div>
                                                        </div>
                                                        <div class="col px-8 py-6">
                                                            <div class="font-size-sm text-muted font-weight-bold">Commission</div>
                                                            <div class="font-size-h4 font-weight-bolder">MYR {{$payment_summary['admin_commission']}}</div>
                                                        </div>
                                                    </div>
                                                    <!--end::Row-->
                                                    <!--begin::Row-->
                                                    <div class="row m-0">
                                                        <div class="col px-8 py-6 mr-8">
                                                            <div class="font-size-sm text-muted font-weight-bold"> Restaurant payments</div>
                                                            <div class="font-size-h4 font-weight-bolder">MYR {{$payment_summary['restaurant_payment']}}</div>
                                                        </div>
                                                        <div class="col px-8 py-6">
                                                            <div class="font-size-sm text-muted font-weight-bold">Restaurant Payouts</div>
                                    ...
                                    <div class="col-lg-6 col-xxl-8">
                                        ...
                                        <div class="card card-custom card-stretch gutter-b">
                                            <!--begin::Header-->
                                            @include('admin.restaurants.all_restaurants.initial_datatable')
                                            <!--end::Header-->
                                            <!--begin::Body-->

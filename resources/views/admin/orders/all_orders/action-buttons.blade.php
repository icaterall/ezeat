<div class="btn-group" role="group">
	...
	<a href="{{route('admin.viewOrder',[$row->id,$row->secret])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo12\dist/../src/media/svg/icons\Communication\Share.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
...
<a data-toggle="modal" data-url= "{{ route('admin.orders.destroy',$row->id)}}" data-id="{{$row->id}}" data-target="#delete-modal" class="remove-record btn btn-icon btn-light btn-hover-primary btn-sm">
